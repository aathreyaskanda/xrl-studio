...
from utils.session_state import init_session_state, mark_step_complete
...
labels = [f"{profile.icon} {profile.display_name}" for profile in profiles]
...
if st.button("Confirm Mission", type="primary", icon="✅"):
    ...
    st.page_link("pages/5_Upload_Layout.py", label="Continue to Upload / Select Layout", icon="🖼️")
